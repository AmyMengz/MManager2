...
public class UtilsUI {
    ...
    public static Drawer setNavigationDrqwer(Activity activity, final Context context, Toolbar toolbar,
        ...
        int header;
        AppPreferences appPerferences = MLManagerApplication.getAppPreferences();
        ...
        drawerBuilder.withActivity(activity)
                ...
                .withStatusBarColor(UtilsUI.darker(appPerferences.getPrimaryColorPref(), 0.8));
        if (MLManagerApplication.isPro()) {

        } else {
            drawerBuilder.addDrawerItems(
                    new PrimaryDrawerItem().withName("Installed App").withIcon(GoogleMaterial.Icon.gmd_phone_android).withBadge(apps).withBadgeStyle(badgeStyle).withIdentifier(1),
                    new PrimaryDrawerItem().withName("System Apps").withIcon(GoogleMaterial.Icon.gmd_android).withBadge(systemApps).withBadgeStyle(badgeStyle).withIdentifier(2),
